...
-- ============================================
-- Note: Storage bucket 'bug-screenshots' must be created via Supabase Dashboard:
-- 1. Go to Storage in Supabase Dashboard
-- 2. Create new bucket: 'bug-screenshots' (public)
-- 3. Add policies for insert (anyone), select (public), delete (service_role)
